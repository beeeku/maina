---
title: Commands
description: All 24 Maina commands organized by workflow phase -- Define, Build, Verify, and Meta.
---

Maina has 24 commands organized into four workflow phases. Every command draws from the three engines -- Context, Prompt, and Verify -- as needed.
